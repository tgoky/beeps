...
// ──────────────────────────────────────────────────────────────
// Request Service Modal (extracted to avoid re-creation)
// ──────────────────────────────────────────────────────────────
...
function RequestServiceModal({
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-2xl rounded-2xl border overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 ${
          theme === "dark"
      ...
      >
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          {submitError && (
            <div
              className={`p-4 rounded-lg border flex items-start gap-3 animate-in slide-in-from-top-2 ${
                theme === "dark"
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className={`w-full px-4 py-3 text-sm rounded-lg border transition-all focus:outline-none focus:ring-2 ${
                theme === "dark"
        ...
        >
          <button
            ...
            className={`flex-1 px-5 py-3 text-sm font-medium rounded-lg border transition-all active:scale-95 disabled:opacity-50 ${
              theme === "dark"
          ...
          <button
            ...
            disabled={isSubmitting}
            className={`flex-1 flex items-center justify-center gap-2 px-5 py-3 text-sm font-medium rounded-lg border transition-all active:scale-95 disabled:opacity-50 ${
              theme === "dark"
...
export default function ProducerDetailPage() {
  ...
  if (error || !producer) {
    return (
      ...
      >
        <div
          className={`p-8 rounded-2xl border max-w-md text-center ${
            theme === "dark"
  ...
  // ── Safe to use producer now ──
  const displayName = producer.name || producer.email.split("@")[0];
  const totalPlays = producer.beats.reduce(
    (sum, beat) => sum + (beat.likeCount * 100),
    0
  );
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <button
            onClick={() => router.push("/producers")}
            className={`flex items-center gap-2 mb-8 px-4 py-2 text-sm rounded-lg border transition-all hover:scale-105 ${
              theme === "dark"
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="flex-shrink-0">
              <div className="relative group">
                <div
                  className={`absolute inset-0 rounded-2xl blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500 ${
                    theme === "dark"
                ...
                {producer.verified && (
                  <div
                    className={`absolute -bottom-2 -right-2 w-12 h-12 rounded-full border-4 bg-blue-500 flex items-center justify-center shadow-lg animate-in zoom-in ${
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className={`text-2xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
                    {formatNumber(producer.followersCount ?? 0)}
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <Music2 className={`w-4 h-4 ${theme === "dark" ? "text-pink-400" : "text-pink-600"}`} />
                    <span className={`text-xs font-medium ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>
                      Beats
                    </span>
                  </div>
                ...
                <div className="flex-1">
                  ...
                  {producer.location && (
                    <div className="flex items-center gap-2 mb-4">
                      <MapPin className={`w-4 h-4 ${theme === "dark" ? "text-zinc-500" : "text-gray-500"}`} />
                  ...
                  {producer.bio && (
                    <p className={`text-base mb-6 leading-relaxed ${theme === "dark" ? "text-zinc-300" : "text-gray-700"}`}>
                      {producer.bio}
                    </p>
                  )}
              ...
              {isOwnProfile && canEdit ? (
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-lg border transition-all hover:scale-105 active:scale-95 ${
                      theme === "dark"
                        ? "bg-white border-white text-black hover:bg-zinc-100"
                        : "bg-black border-black text-white hover:bg-gray-800"
                    }`}
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-lg border transition-all hover:scale-105 active:scale-95 shadow-lg ${
                      theme === "dark"
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Tab Navigation */}
            <div
              className={`flex items-center gap-1 p-1.5 rounded-xl border w-fit ${
              ...
              <div className="space-y-4">
                {producer.beats.length > 0 ? (
                  producer.beats.map((beat) => (
                    <div
                      key={beat.id}
                      className={`group p-6 rounded-xl border transition-all hover:scale-[1.02] cursor-pointer ${
                        theme === "dark"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mb-3">
                            <div className="flex items-center gap-1.5">
                              <Play className={`w-4 h-4 ${theme === "dark" ? "text-zinc-500" : "text-gray-500"}`} />
                              <span className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>
                                {formatNumber(beat.likeCount * 100)} plays
                              </span>
                            </div>
                            <div className="flex items-center gap-1.5">
                              <Heart className={`w-4 h-4 ${theme === "dark" ? "text-zinc-500" : "text-gray-500"}`} />
                              <span className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>
                                {beat.likeCount}
                              </span>
                            </div>
                  ...
                  <div
                    className={`p-16 rounded-xl border text-center ${
                      theme === "dark" ? "bg-zinc-950 border-zinc-800" : "bg-white border-gray-300"
                    }`}
                  >
                    <Music2 className={`w-16 h-16 mx-auto mb-4 ${theme === "dark" ? "text-zinc-700" : "text-gray-400"}`} />
                    <p className={`text-sm ${theme === "dark" ? "text-zinc-500" : "text-gray-600"}`}>
            ...
            {activeTab === "about" && (
              ...
              >
                ...
                <p className={`text-base leading-relaxed ${theme === "dark" ? "text-zinc-300" : "text-gray-700"}`}>
            ...
            {activeTab === "reviews" && (
              ...
              >
                <Star className={`w-16 h-16 mx-auto mb-4 ${theme === "dark" ? "text-zinc-700" : "text-gray-400"}`} />
                <p className={`text-sm ${theme === "dark" ? "text-zinc-500" : "text-gray-600"}`}>
                  No reviews yet
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className={`text-sm font-semibold mb-4 flex items-center gap-2 ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Projects</span>
                    <span className={`text-lg font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
                      {producer.beats.length + (producer.services?.length ?? 0)}+
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Response Time</span>
                    <span className={`text-lg font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>~2h</span>
                  </div>
                  <div className={`h-2 rounded-full overflow-hidden ${theme === "dark" ? "bg-zinc-800" : "bg-gray-200"}`}>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Satisfaction</span>
                    <span className={`text-lg font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>98%</span>
                  </div>
                  <div className={`h-2 rounded-full overflow-hidden ${theme === "dark" ? "bg-zinc-800" : "bg-gray-200"}`}>
                ...
                <div className="space-y-3">
                  {producer.studios.map((studio) => (
                    ...
                    >
                      ...
                      <div className={`text-xs mb-2 ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>
                        {studio.location}
                      </div>
                      <div className={`text-sm font-bold ${theme === "dark" ? "text-purple-400" : "text-purple-600"}`}>
